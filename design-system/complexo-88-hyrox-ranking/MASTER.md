# Brand lock (Complexo 88) — overrides palette suggestions

- Keep **Complexo 88** brand: charcoal/black background, accent **#FFCC00**, white text.
- Do **not** switch primary to orange (#F97316). Map "primary/energy" → `#FFCC00`.
- Typography may use **Barlow Condensed + Barlow** (sports) OR keep Bebas Neue + Oswald; prefer Barlow Condensed for ranking numbers/names if it reads cleaner on TV/phone.
- Product: Hyrox gym ranking + moral chat + admin — mobile-first, TV-friendly.
...
**Project:** Complexo 88 Hyrox Ranking
**Generated:** 2026-09-19 00:03:41
